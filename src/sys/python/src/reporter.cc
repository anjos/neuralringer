...
void bind_sys_reporter()
{
    ...
    .def("report", &sys::Reporter::report, (arg("info")), "Reports something to the user") 
    .def("warn", &sys::Reporter::warn, (arg("info")), "Reports a warning message to the user") 
    .def("exception", &sys::Reporter::except, (arg("info")), "Reports something exceptional to the user, raises an exception") 
		;
}
